...
__align(4) uint8_t gu8ConfigDescriptor[] = {
    ...
    0x01,               /* bFormatType(0x01): FORMAT_TYPE_I */
    0x04,               /* bSubSlotSize(0x04)  :  4 bytes per sample */
    32,               /* bBitResolution(32): 32 bits per sample */

    /* Standard AS Isochronous output Endpoint Descriptor */
    0x07,                                   /* bLength */
    0x05,                                   /* bDescriptorType */
    ISO_OUT_EP_NUM | EP_OUTPUT,             /* bEndpointAddress */
    0x05,                                   /* bmAttributes */
    (200 + 0)&0xff, ((200 + 0)>>8)&0xff,    /* wMaxPacketSize note */
    ...
    ISO_IN_EP_NUM | EP_INPUT,       /* bEndpointAddress (D3:0 - EP no. D6:4 - reserved 0. D7 - 0:out, 1:in) */
    0x11,                           /* bmAttributes (bitmap)  */ 
    EPA_BUF_LEN, 0x0,               /* wMaxPacketSize 4 bytes */
    0x02,                           /* bInterval */
